...
meal_price = float((input("How much was the diner?").replace(',','.'))) #ensures the quantity is separated by a decima pont not by a comma.
...
if tip_selected == "1":
    ...
    print(f"The tip amount is ${tip_amount:.2f} ***Thank you!****")
elif tip_selected == "2":
